...
import Web.Internal.DOMBuilder (getCurrentNode)
...
containedButton { label } =
  Web.button (attr "class" "mdc-button mdc-button--raised initAside-button") mempty (S.do
    ...
    span (attr "class" "mdc-button__label") mempty (label >>> empty)) # bracket (getCurrentNode >>= newComponent material.ripple."MDCRipple") (const $ pure) (const $ pure) # clickable
...
filledTextField { floatingLabel } value =
  label (attr "class" "mdc-text-field mdc-text-field--filled mdc-text-field--label-floating") mempty (S.do
    ...
    span (attr "class" "mdc-line-ripple") mempty empty ) # bracket (getCurrentNode >>= newComponent material.textField."MDCTextField") (const $ pure) (const $ pure)
...
checkbox { labelContent } checked =
  div (attr "class" "mdc-form-field") mempty ( S.do
    div (attr "class" "mdc-checkbox") mempty ( S.do
      ...
      div (attr "class" "mdc-checkbox__ripple") mempty empty ) # bracket (getCurrentNode >>= newComponent material.checkbox."MDCCheckbox") (const $ pure) (const $ pure)
...
radioButton { labelContent } value =
  ...
  div (attr "class" "mdc-radio") mempty (S.do
      ...
      div (attr "class" "mdc-radio__ripple") mempty empty) # bracket (getCurrentNode >>= newComponent material.radio."MDCRadio") (const $ pure) (const $ pure)
