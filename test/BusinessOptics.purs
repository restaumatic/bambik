...
-- | `subResolving` (row, sub-Record focus): price an order line, focusing only the
...
-- | `subRetaining` (row, sub-Variant focus): the dual of `subResolving`. Focus the
...
countdownStep = subRetaining @"pending"
