...
import Data.Invariant.Optics (constructorInvPrism, invAffineTraversal, invLens, projection, property)
...
items = property (Proxy :: Proxy "items")
...
note = property (Proxy :: Proxy "note")
