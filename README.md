...
nothing vendored. The [v0.1.2 release](https://github.com/restaumatic/bambik/releases/tag/v0.1.2)
...
curl -sL https://github.com/restaumatic/bambik/releases/download/v0.1.2/developing-bambik-apps-v0.1.2.tar.gz | tar xz -C .claude/skills
```
