(() => {
    ...
    return {
      ...
      recordToRecord: function() {
        return function(dictOwnedRecordOutputs) {
          ...
          return function(p1) {
            return function(p2) {
              return wrap2(apply3(map6(function() {
  ...
  var semigroupoidUI = function(dictApply) {
    ...
    return {
      compose: function(p2) {
        return function(p1) {
          return wrap2(apply3(map6(function(v) {
            return function(v1) {
              return {
                toUser: function(cha) {
                  return v.toUser(cha);
  ...
  var updates = function(dictFunctor) {
    ...
    return function(handler) {
      return function(events) {
        return wrap2(mapFlipped2(unwrap2(events))(function(evts) {
    ...
    return function(w) {
      return wrap3(bind1(unwrap3(w))(function(w$prime) {
        return bind1(gets2(function(v) {
          ...
          return discard22(liftEffect2(setAttribute(node)("style")("display: none;")))(function() {
            return pure1({
              toUser: function(i1) {
                return function __do() {
                  (function() {
  ...
  var init2 = function(nodeInitializer) {
    return function(pre) {
      return function(post) {
        return function(w) {
          return wrap3(bind1(unwrap3(w))(function(w$prime) {
  ...
  var sliderLeaf = function(config) {
    ...
    return wrap4(bind4(unwrap4(staticHTML(markup)))(function() {
      return bind4(gets3(function(v) {
        ...
        return bind4(liftEffect3(newComponent(material.slider.MDCSlider)(node)))(function(comp) {
          return bind4(liftEffect3($$new(Nothing.value)))(function(mPropRef) {
            return discard1(liftEffect3(listen(comp)("MDCSlider:input")(function __do() {
              var v = getSliderValue(comp)();
              var mProp = read(mPropRef)();
              return for_22(mProp)(function(prop2) {
                return $$void4(prop2(v));
              })();
            })))(function() {
              return discard1(liftEffect3(listen(comp)("MDCSlider:change")(function __do() {
                var v = getSliderValue(comp)();
                var mProp = read(mPropRef)();
                return for_22(mProp)(function(prop2) {
                  return $$void4(prop2(v));
  ...
  var containedButton = function(v) {
    return function() {
      var $363 = init2(newComponent(material.ripple.MDCRipple))(mempty1)(mempty4);
  ...
  var on1 = /* @__PURE__ */ on2(redoIsSymbol);
  var undoIsSymbol = {
    reflectSymbol: function() {
      return "undo";
    }
  };
  var on22 = /* @__PURE__ */ on2(undoIsSymbol);
  ...
  var diameterIsSymbol = {
    reflectSymbol: function() {
      return "diameter";
    }
  };
  var updates2 = /* @__PURE__ */ updates(functorWeb);
  var discard7 = /* @__PURE__ */ discard3(/* @__PURE__ */ recordToVariantUI(applicativeWeb))()();
  var button3 = /* @__PURE__ */ button2(undoIsSymbol)();
  var button1 = /* @__PURE__ */ button2(redoIsSymbol)();
  var pushUndo = function(m) {
    return {
      circles: m.circles,
      selected: m.selected,
      diameter: m.diameter,
      adjusting: m.adjusting,
      undoStack: take(100)(snoc(m.undoStack)(m.circles)),
      redoStack: []
    };
  };
  ...
  var hasSelection = function(m) {
    return isJust(m.selected);
  };
  var dist = function(c) {
    return function(x) {
      return function(y) {
  ...
  var handle = function(e) {
    return function(m) {
      return on1($$Proxy.value)(function(v) {
        var v1 = unsnoc(m.redoStack);
        if (v1 instanceof Just) {
          return {
            diameter: m.diameter,
            circles: v1.value0.last,
            redoStack: v1.value0.init,
            undoStack: snoc(m.undoStack)(m.circles),
            selected: Nothing.value,
            adjusting: false
          };
        }
        ...
        ;
        throw new Error("Failed pattern match at Main (line 63, column 39 - line 66, column 19): " + [v1.constructor.name]);
      })(on22($$Proxy.value)(function(v) {
        var v1 = unsnoc(m.undoStack);
        if (v1 instanceof Just) {
          return {
            diameter: m.diameter,
            circles: v1.value0.last,
            undoStack: v1.value0.init,
            redoStack: snoc(m.redoStack)(m.circles),
            selected: Nothing.value,
            adjusting: false
          };
        }
        ...
        ;
        throw new Error("Failed pattern match at Main (line 59, column 39 - line 62, column 19): " + [v1.constructor.name]);
      })(on3($$Proxy.value)(function(v) {
        var v1 = findIndex(function(c) {
          return dist(c)(v.x)(v.y) <= c.r;
        })(m.circles);
        if (v1 instanceof Just) {
          return {
            circles: m.circles,
            ...
            selected: new Just(v1.value0),
            diameter: fromMaybe(m.diameter)(map5(function(c) {
              return 2 * c.r;
            })(index(m.circles)(v1.value0))),
            adjusting: false
          };
        }
        ;
        if (v1 instanceof Nothing) {
          var v2 = pushUndo(m);
          return {
            adjusting: v2.adjusting,
            diameter: v2.diameter,
            redoStack: v2.redoStack,
            undoStack: v2.undoStack,
            circles: snoc(m.circles)({
              x: v.x,
              y: v.y,
              r: 20
            }),
        ...
        ;
        throw new Error("Failed pattern match at Main (line 56, column 7 - line 58, column 99): " + [v1.constructor.name]);
      })(case_)))(e);
    };
  };
  var diameterField = function(m) {
    return {
      diameter: m.diameter
    };
  };
  var canvas = /* @__PURE__ */ function() {
    var render = function(m) {
      return joinWith("")(mapWithIndex2(function(i2) {
        return function(c) {
          return '<circle cx="' + (show3(c.x) + ('" cy="' + (show3(c.y) + ('" r="' + (show3(c.r) + ('" stroke="#333" fill="' + (function() {
            var $77 = eq2(m.selected)(new Just(i2));
            if ($77) {
              return "#ddd";
            }
            ;
    ...
    return viewEvents('<svg viewBox="0 0 500 300" style="border: 1px solid #ccc; display: block; margin: 10px 0; background: white; width: 100%; max-width: 500px; height: auto; touch-action: none;"></svg>')(render)(function(node) {
      return function(emit) {
        return onCanvasClick(node)(function(x) {
          return function(y) {
  ...
  var applyDiameter = function(m) {
    var v = function(v1) {
      return m;
    };
    if (m.selected instanceof Just) {
      var $79 = index(m.circles)(m.selected.value0);
      if ($79 instanceof Just) {
        var $80 = $79.value0.r !== m.diameter / 2;
        if ($80) {
          ...
          return {
            selected: m$prime.selected,
            diameter: m$prime.diameter,
            adjusting: m$prime.adjusting,
            undoStack: m$prime.undoStack,
            redoStack: m$prime.redoStack,
            circles: fromMaybe(m.circles)(updateAt(m.selected.value0)({
              x: $79.value0.x,
              y: $79.value0.y,
              r: m.diameter / 2
            })(m.circles))
  ...
  var main = /* @__PURE__ */ function() {
    return bodyWith(initial)(elevation20(card({
      caption: new Just("Circle Drawer")
    })(looped(functorWeb)(discard4(semigroupoidUI(applyWeb))(rmap(profunctorUI3)(applyDiameter)(completed(strongUI(functorWeb))()()()()(fieldNamesCons(diameterIsSymbol)()()()(fieldNamesNilRow))(shownWhen(hasSelection)(lcmap(profunctorUI3)(diameterField)(slider(diameterIsSymbol)()({
      label: "Diameter",
      min: 4,
      max: 200,
      step: Nothing.value
    }))))))(function() {
      return updates2(handle)(discard7(canvas)(function() {
        return discard7(button3({
          label: new Just("Undo"),
          icon: new Just("undo")
        }))(function() {
          return button1({
