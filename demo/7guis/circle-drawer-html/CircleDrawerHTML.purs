...
import PUI (asField, constantly, foreach, informed, mvu, pempty, toCase, updated)
...
circleDrawerHTML =
  body $ div $ ( Semigroupoid.do
      p ( label $ RecordToRecord.do
          staticText "Diameter "
          rangeInput ) # asField @"diameter" # provided selectedDiameter # updated (informed adjustDiameter)
