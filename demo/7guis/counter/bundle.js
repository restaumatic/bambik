(() => {
  ...
  var lcmap = function(dictProfunctor) {
    ...
    return function(a2b) {
      return dimap1(a2b)(identity3);
    };
  };
  var rmap = function(dictProfunctor) {
    var dimap1 = dimap(dictProfunctor);
    return function(b2c) {
      return dimap1(identity3)(b2c);
    };
  };
  ...
  var headline4 = function(w) {
    return cl("mdc-typography--headline4")(h4(w));
  };
  ...
  var countCaption = function(r) {
    return show2(r.count);
  };
  var main = /* @__PURE__ */ function() {
    return bodyWith({
      count: 0
    })(elevation20(card({
      caption: new Just("Counter")
    })(looped(functorWeb)(discard3(semigroupoidUI(applyWeb))(completed(strongUI(functorWeb))()()()()(fieldNamesNilRow)(headline4(lcmap(profunctorUI(functorWeb))(countCaption)(text))))(function() {
      return updates2(increment)(button3({
        label: new Just("Count"),
        icon: Nothing.value
      }));
    })))));
  }();
