(() => {
  ...
  var discard2 = function(dictRecordToRecord) {
    ...
    return function() {
      return function(dictOwnedRecordOutputs) {
        var MergeableRecords1 = dictOwnedRecordOutputs.MergeableRecords1();
        var bind23 = bind12(ownedRecordOutputs2(mergeableRecords2(MergeableRecords1.FieldNames1())()(MergeableRecords1.FieldNames3())));
        return function(first2) {
          return function(cont) {
            return bind23(first2)(function(v) {
              return cont(unit);
            });
          };
        };
  ...
  var recordToRecordUI = function(dictApplicative) {
    ...
    return {
      pempty: wrap3(pure(dictApplicative)({
        toUser: mempty2,
        fromUser: function(prop2) {
          return $$void3(prop2({}));
        }
      ...
      recordToRecord: function() {
        return function(dictOwnedRecordOutputs) {
          ...
          return function(p1) {
            return function(p2) {
              return wrap3(apply2(map4(function() {
  ...
  var semigroupoidUI = function(dictApply) {
    ...
    return {
      compose: function(p2) {
        return function(p1) {
          return wrap3(apply2(map4(function(v) {
            return function(v1) {
              return {
                toUser: function(cha) {
                  return v.toUser(cha);
  ...
  var updates = function(dictFunctor) {
    ...
    return function(handler) {
      return function(events) {
        return wrap3(mapFlipped2(unwrap2(events))(function(evts) {
  ...
  var looped = function(dictFunctor) {
    var mapFlipped2 = mapFlipped(dictFunctor);
    return function(p2) {
      return wrap3(mapFlipped2(unwrap2(p2))(function(p$prime) {
  ...
  var every = function(dictApplicative) {
    var mapFlipped2 = mapFlipped(dictApplicative.Apply0().Functor0());
    var pure22 = pure(dictApplicative);
    return function(interval) {
      return function(step) {
        return wrap3(mapFlipped2(pure22(unit))(function(v) {
          var mPropRef = unsafePerformEffect($$new(Nothing.value));
          var lastRef = unsafePerformEffect($$new(Nothing.value));
          return {
            toUser: function(a) {
              return function __do() {
                write(new Just(a))(lastRef)();
                var mProp = read(mPropRef)();
                return for_2(mProp)(function(prop2) {
            ...
            fromUser: function(prop2) {
              return function __do() {
                write(new Just(prop2))(mPropRef)();
                var $lazy_loop = $runtime_lazy3("loop", "UI", function() {
                  return discard22(delay(interval))(function() {
                    return discard22(liftEffect2(function __do2() {
                      var ma = read(lastRef)();
                      return for_2(bind22(ma)(step))(function(a$prime) {
                        return function __do3() {
                          write(new Just(a$prime))(lastRef)();
                          return $$void3(prop2(a$prime))();
                        };
                      })();
                    }))(function() {
                      return $lazy_loop(395);
                    });
                  });
                });
                var loop = $lazy_loop(388);
                return launchAff_(loop)();
              };
            }
          };
        }));
  ...
  var liftEffect3 = /* @__PURE__ */ liftEffect(monadEffectWeb);
  ...
  var discard23 = /* @__PURE__ */ discard5(bindWeb);
  ...
  var text = /* @__PURE__ */ wrap4(/* @__PURE__ */ bind1(/* @__PURE__ */ gets2(function(v) {
    return v.parent;
  }))(function(parentNode) {
    return bind1(liftEffect3(function __do() {
      ...
      return discard23(modify_2(function(v) {
        ...
        return bind1(gets2(function(v) {
          ...
          return bind1(liftEffect3($$new(unit)))(function(propRef) {
            return pure1({
              toUser: function(s) {
                return function __do() {
  ...
  var staticText = function(text1) {
    return wrap4(bind1(gets2(function(v) {
      return v.parent;
    }))(function(parentNode) {
      return bind1(liftEffect3(function __do() {
  ...
  var staticHTML = function(html) {
    return wrap4(bind1(gets2(function(v) {
      ...
      return bind1(liftEffect3(appendRawHtml(html)(parent)))(function(newNode) {
        return discard23(modify_2(function(v) {
          var $87 = {};
          for (var $88 in v) {
      ...
      return function(callback) {
        return function(ui) {
          return runDomInNode(node)(bind1(unwrap3(ui))(function(v) {
            return discard23(liftEffect3(v.fromUser(function(b) {
              return function __do() {
                callback(b)();
                return Nothing.value;
              };
            })))(function() {
              return void1(liftEffect3(v.toUser(initial)));
            });
          }));
        };
      };
  ...
  var init = function(nodeInitializer) {
    return function(pre) {
      return function(post) {
        return function(w) {
          return wrap4(bind1(unwrap3(w))(function(w$prime) {
            return bind1(gets2(function(v) {
              return v.sibling;
            }))(function(node) {
              return bind1(liftEffect3(nodeInitializer(node)))(function(ctx) {
                return pure1({
                  toUser: function($$new2) {
                    return function __do() {
                      pre(ctx)();
  ...
  var element = function(tagName) {
    return function(contents) {
      return bind1(liftEffect3(createElement(tagName)))(function(newNode) {
        return bind1(gets2(function(v) {
          return v.parent;
        }))(function(parentNode) {
          return discard23(liftEffect3(appendChild(newNode)(parentNode)))(function() {
            return discard23(modify_2(function(v) {
              var $96 = {};
              for (var $97 in v) {
  ...
  var clazz = function(name2) {
    return bind1(gets2(function(v) {
      ...
      return discard23(liftEffect3(addClass(node)(name2)))(function() {
        return pure1(unit);
      });
    });
  };
  ...
  var attribute = function(name2) {
    return function(value) {
      return bind1(gets2(function(v) {
        ...
        return liftEffect3(setAttribute(node)(name2)(value));
      });
    };
  };
      ...
      return function(w) {
        ...
        return wrap4(bind1(unwrap3(w))(function(w$prime) {
          return bind1(gets2(function(v) {
            ...
            return discard23(liftEffect3(updateAttribute(node)(Nothing.value)))(function() {
              return pure1({
                toUser: function(mch) {
                  return function __do() {
  ...
  var button = function(w) {
    return wrap4(bind1(unwrap3(attrDyn("disabled")(function(x) {
      var $106 = isNothing(x);
      if ($106) {
      ...
      return bind1(liftEffect3($$new(Nothing.value)))(function(mARef) {
        return bind1(gets2(function(v) {
          return v.sibling;
        }))(function(node) {
          return pure1({
  ...
  var sliderLeaf = function(config) {
    ...
    return wrap5(bind3(unwrap4(staticHTML(markup)))(function() {
      return bind3(gets3(function(v) {
        return v.sibling;
      }))(function(node) {
        return bind3(liftEffect4(newComponent(material.slider.MDCSlider)(node)))(function(comp) {
          return bind3(liftEffect4($$new(Nothing.value)))(function(mPropRef) {
            return discard1(liftEffect4(listen(comp)("MDCSlider:input")(function __do() {
              ...
              return discard1(liftEffect4(listen(comp)("MDCSlider:change")(function __do() {
                var v = getSliderValue(comp)();
                var mProp = read(mPropRef)();
                return for_22(mProp)(function(prop2) {
                  return $$void5(prop2(v));
  ...
  var slider = function(dictIsSymbol) {
    ...
    return function() {
      return function(config) {
        return field2(sliderLeaf(config));
      };
    };
  };
  ...
  var card = function(v) {
    return function(content) {
      ...
      }()(div2(wrap5(discard1(for_5(v.caption)(function(c) {
  ...
  var discard7 = /* @__PURE__ */ discard3(/* @__PURE__ */ semigroupoidUI(applyWeb));
  var durationIsSymbol = {
    reflectSymbol: function() {
      return "duration";
    }
  };
  var fieldNamesCons2 = /* @__PURE__ */ fieldNamesCons(durationIsSymbol)()()()(fieldNamesNilRow);
  var discard12 = /* @__PURE__ */ discard2(/* @__PURE__ */ recordToRecordUI(applicativeWeb))()(/* @__PURE__ */ ownedRecordOutputs()(/* @__PURE__ */ mergeableRecords()(fieldNamesNilRow)()(fieldNamesCons2)));
  var lcmap2 = /* @__PURE__ */ lcmap(/* @__PURE__ */ profunctorUI(functorWeb));
  var slider2 = /* @__PURE__ */ slider(durationIsSymbol)();
  var every2 = /* @__PURE__ */ every(applicativeWeb);
  var updates2 = /* @__PURE__ */ updates(functorWeb);
  var button3 = /* @__PURE__ */ button2({
    reflectSymbol: function() {
      return "reset";
    }
  })();
  var tick = function(t) {
    if (t.elapsed < t.duration) {
      return new Just({
        duration: t.duration,
        elapsed: min3(t.duration)(t.elapsed + 0.1)
      });
    }
    ;
    if (otherwise) {
    ...
    ;
    throw new Error("Failed pattern match at Main (line 40, column 1 - line 40, column 29): " + [t.constructor.name]);
  };
  ...
  var gauge = function(t) {
    var filled = function() {
      ...
      ;
      return min1(20)(round2(t.elapsed / t.duration * toNumber(20)));
    }();
    return joinWith("")(replicate(filled)("\u2588")) + joinWith("")(replicate(20 - filled | 0)("\u2591"));
  };
  var format = /* @__PURE__ */ toStringWith(/* @__PURE__ */ fixed(1));
  var elapsedCaption = function(t) {
    return format(t.elapsed) + ("s / " + (format(t.duration) + "s"));
  };
  var main = /* @__PURE__ */ function() {
    return bodyWith({
      ...
      caption: new Just("Timer")
    })(looped(functorWeb)(discard7(completed(strongUI(functorWeb))()()()()(fieldNamesCons2)(discard12(headline6(lcmap2(gauge)(text)))(function() {
      return discard12(body1(lcmap2(elapsedCaption)(text)))(function() {
        return slider2({
          label: "Duration",
          min: 0,
          max: 60,
      ...
      return discard7(every2(100)(tick))(function() {
        return updates2(reset)(button3({
          label: new Just("Reset"),
          icon: new Just("replay")
        }));
      });
    })))));
  }();
