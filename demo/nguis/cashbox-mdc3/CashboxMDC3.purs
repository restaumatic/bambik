      ...
      card { caption: "Cashbox" } $ ( Semigroupoid.do
          ...
          ( Semigroupoid.do
              ...
              ( VariantToVariant.do
                  ...
                  ( simpleDialog { title: "Pay the courier?", confirm: "Pay" } $ bodyLarge text # projected payoutLine # tapped ) # onCase @"payout" # toCase @"paidOut" identity ) # focusVariant) # updated (match { refunded: applyRefund, paidOut: applyPayout, counted: recordAudit })
      ) # mvu openedTill
