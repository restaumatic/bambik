module InboxMD3 (inboxMD3) where
  ...
  body $
    elevation5 $
      card { caption: "Inbox" } $ ( Semigroupoid.do
          ...
          ( Semigroupoid.do
              ( RecordToRecord.do
                  headlineSmall text # projection subjectLine
                  bodyMedium RecordToRecord.do
                    staticText "From: "
                    text # forValue # forField @"sender"
                  bodyLarge text # projection bodyLine) # tapped
...
inboxZeroBanner = snackbar # forCase @"emptied" # constantly (.emptied "Inbox zero!")
