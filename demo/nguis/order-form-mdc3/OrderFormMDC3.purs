      ...
      ( Category.do
          ...
          card ( Category.do
              ...
              ( ( Category.do
                    ...
                    ( Category.do
                        ...
                        ( bodyLarge $ text @"distanceLine" ) # shownWhen @"estimated" distanceOf ) # inCase @"Delivery" selection ) # bracketed fulfillmentState fulfillmentCase ) # field @"fulfillment" )
          card $ Category.do
          ...
          card ( Category.do
              ...
              ( Category.do
                  ...
                  ( bodyLarge $ text @"payingLine" ) # shown ) # field @"payment" )
          card $ Category.do
