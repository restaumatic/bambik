...
import PUI (asCase, completed, displayed, everyOn, forValue, foreach, mvu, projection, updates, widenRecordInput)
  ...
  body $
    elevation20 $
      card { caption: "Stopwatch" } $ ( Semigroupoid.do
          ...
          ul ( (li text # projection _.line) # foreach @"line" ) # lcmap lapLines # widenRecordInput # displayed
      ) # mvu zeroedStopwatch
