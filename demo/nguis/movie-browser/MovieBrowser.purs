...
movieCatalogue :: { category :: [ all :: {}, action :: {}, drama :: {}, comedy :: {} ], classic :: Boolean, cult :: Boolean, oscar :: Boolean, movies :: Array { title :: String, year :: Int, category :: [ all :: {}, action :: {}, drama :: {}, comedy :: {} ], tags :: Array String, rating :: Number, favorite :: Boolean } }
movieCatalogue =
  { category: .all {}
  , classic: false
  , cult: false
...
markFavorite :: { title :: String, year :: Int, rating :: Number, favorite :: Boolean } -> { movies :: Array { title :: String, year :: Int, category :: [ all :: {}, action :: {}, drama :: {}, comedy :: {} ], tags :: Array String, rating :: Number, favorite :: Boolean } } -> { movies :: Array { title :: String, year :: Int, category :: [ all :: {}, action :: {}, drama :: {}, comedy :: {} ], tags :: Array String, rating :: Number, favorite :: Boolean } }
...
favoriteCount :: { movies :: Array { title :: String, year :: Int, category :: [ all :: {}, action :: {}, drama :: {}, comedy :: {} ], tags :: Array String, rating :: Number, favorite :: Boolean } } -> Int
favoriteCount { movies } = length (filter _.favorite movies)

soleFavorite :: { movies :: Array { title :: String, year :: Int, category :: [ all :: {}, action :: {}, drama :: {}, comedy :: {} ], tags :: Array String, rating :: Number, favorite :: Boolean } } -> Maybe { count :: Int }
soleFavorite { movies } = if favoriteCount { movies } == 1 then Just { count: 1 } else Nothing

severalFavorites :: { movies :: Array { title :: String, year :: Int, category :: [ all :: {}, action :: {}, drama :: {}, comedy :: {} ], tags :: Array String, rating :: Number, favorite :: Boolean } } -> Maybe { count :: Int }
