module SignupFormMD3 (signupFormMD3) where
...
import PUI.Web (Web)
import PUI.MDC3 (bodyMedium, button, card, checkbox, debouncedTextField, elevation5, filledTextField, headlineLarge, radioButton, select, snackbar, titleSmall, tooltip)
import QualifiedDo.Semigroupoid as Semigroupoid

signupFormMD3 :: Effect Unit
signupFormMD3 =
  body $
    elevation5 $
      card { caption: "Sign-Up Form" } Semigroupoid.do
        ...
        ( bodyMedium $ staticText "Pick a username to check its availability" ) # provided # lcmap whenUnnamed # displayed
