...
dineIn :: PropOptic' { table :: Table } Fulfillment
dineIn = constructor "dineIn" DineIn case _ of
  DineIn c -> Just c
  _ -> Nothing

takeaway :: PropOptic' { time :: String } Fulfillment
takeaway = constructor "takeaway" Takeaway case _ of
  Takeaway c -> Just c
  _ -> Nothing

delivery :: PropOptic' { address :: Address } Fulfillment
...
formal :: PropOptic' NameFormal NameInformal
