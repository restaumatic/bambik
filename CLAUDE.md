...
- `Pipeline.do` (qualified-do; `import QualifiedDo.Semigroupoid as Pipeline` in application code) - data-flow pipelines
...
`PUI Web`: `(dynamic …) # shownAlways` over element oculars, since structure
