...
export const sets = {
  '7guis': {
    ...
    // non-Material siblings (PUI.Web.Shoelace/Fluent/Bootstrap) and the
    // plain-HTML floor (PUI.Web.HTML alone) — same app, import switched
    'counter-shoelace': ['CounterShoelace', 'counterShoelace'],
    'temperature-converter-shoelace': ['TemperatureConverterShoelace', 'temperatureConverterShoelace'],
    'flight-booker-shoelace': ['FlightBookerShoelace', 'flightBookerShoelace'],
    'timer-shoelace': ['TimerShoelace', 'timerShoelace'],
    'crud-shoelace': ['CrudShoelace', 'crudShoelace'],
    'circle-drawer-shoelace': ['CircleDrawerShoelace', 'circleDrawerShoelace'],
    'cells-shoelace': ['CellsShoelace', 'cellsShoelace'],
    'counter-fluent': ['CounterFluent', 'counterFluent'],
    'temperature-converter-fluent': ['TemperatureConverterFluent', 'temperatureConverterFluent'],
    'flight-booker-fluent': ['FlightBookerFluent', 'flightBookerFluent'],
    'timer-fluent': ['TimerFluent', 'timerFluent'],
    'crud-fluent': ['CrudFluent', 'crudFluent'],
    'circle-drawer-fluent': ['CircleDrawerFluent', 'circleDrawerFluent'],
    'cells-fluent': ['CellsFluent', 'cellsFluent'],
    'counter-bootstrap': ['CounterBootstrap', 'counterBootstrap'],
    'temperature-converter-bootstrap': ['TemperatureConverterBootstrap', 'temperatureConverterBootstrap'],
    'flight-booker-bootstrap': ['FlightBookerBootstrap', 'flightBookerBootstrap'],
    'timer-bootstrap': ['TimerBootstrap', 'timerBootstrap'],
    'crud-bootstrap': ['CrudBootstrap', 'crudBootstrap'],
    'circle-drawer-bootstrap': ['CircleDrawerBootstrap', 'circleDrawerBootstrap'],
    'cells-bootstrap': ['CellsBootstrap', 'cellsBootstrap'],
    'counter-html': ['CounterHTML', 'counterHTML'],
    'temperature-converter-html': ['TemperatureConverterHTML', 'temperatureConverterHTML'],
    'flight-booker-html': ['FlightBookerHTML', 'flightBookerHTML'],
    'timer-html': ['TimerHTML', 'timerHTML'],
